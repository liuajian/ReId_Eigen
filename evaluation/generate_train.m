...
% root_dir = '/home/ajliu/LAJ/ReId_Eigen/datasets/Market-1501-v15.09.15'
...
save([root_dir '/trainData.mat'], 'trainID', 'trainCAM', 'train_files', 'train_dir');
...
train_list_file = fopen([root_dir '/train.lst'], 'w');
for n = 1:n_train
...
save([root_dir '/testData.mat'], 'testID', 'testCAM', 'test_files');
test_list_file = fopen([root_dir '/test.lst'], 'w');
for n = 1:n_test
...
save([root_dir '/queryData.mat'], 'queryID', 'queryCAM', 'query_files');
query_list_file = fopen([root_dir '/query.lst'], 'w');
for n = 1:n_query
